...
function changeText(){
    headline.innerText = "Here's the New Title"
}
function changeHTML(){
    headline.innerHTML = "Here's the New Title <a href='http://gogle.com'>interactive</a>"
}
function changeStyle(){
    headline.style.color = "red";
    headline.style.backgroundColor = "black"; // Camel Case
